...
void ticket1(int choice,char name[10],int id2,int price)
{
        ...
        printf("\t============================================================\n");
        printf("\t Booking ID : %d \t\t\tShow Name : Salaar : Ceasefire Part-I \n",id2);
        printf("\t Customer  : %s\n",name);
...
int movie(void)
{
	...
	printf("\t\t\t----------------------------\n\n");
	printf("\t\t\tpress 1 for Salaar : Ceasefire Part-I\n\n");
	printf("\t\t\tpress 2 for Captain Miller\n\n");
	printf("\t\t\tpress 3 for Hi Nana\n");
	scanf("%d",&i);
	system("cls");
	return i;
}
void ticket2(int choice,char name[10],int id2,int price)
{
        ...
        printf("\t-----------------THEATER BOOKING TICKET----------------\n");
        printf("\t============================================================\n");
        printf("\t Booking ID : %d \t\t\tShow Name : Captain Miller\n",id2);
        printf("\t Customer  : %s\n",name);
        printf("\t\t\t                              Date      : 10-01-2024\n");
        printf("\t                                              Time      : 05:00pm\n");
        printf("\t                                              Hall      : 03\n");
...
void ticket3(int choice,char name[10],int id2,int price)
{
        ...
        printf("\t-----------------THEATER BOOKING TICKET----------------\n");
        printf("\t============================================================\n");
        printf("\t Booking ID : %d \t\t\tShow Name : Hi Nana \n",id2);
        printf("\t Customer  : %s\n",name);
        printf("\t\t\t                              Date      : 10-01-2024\n");
        printf("\t                                              Time      : 07:00pm\n");
        printf("\t                                              Hall      : 04\n");
